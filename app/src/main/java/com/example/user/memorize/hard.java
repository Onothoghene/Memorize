...
public class hard extends AppCompatActivity {
    ...
    int turn = 1,playerPoints = 0, sec=64;
    String  s;
    //, cpuPoints = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_61.setY(1000);
        iv_61.animate().translationYBy(-1000).setDuration(2500);
        iv_62 =  findViewById(R.id.iv_62);
        iv_62.setY(1000);
        iv_62.animate().translationYBy(-1000).setDuration(2500);
        iv_63 =  findViewById(R.id.iv_63);
        iv_63.setY(1000);
        iv_63.animate().translationYBy(-1000).setDuration(2500);
        iv_64 =  findViewById(R.id.iv_64);
        iv_64.setY(1000);
        iv_64.animate().translationYBy(-1000).setDuration(2500);
    ...
    private void frontOfCardsResources(){
        ...
        image211 = R.drawable.ic_image111;
        image212 = R.drawable.ic_image112;
